...
export class FederalService {
    ...
    public activities(search?: string, activity_id?: number): Observable<Array<any>> {
        ...
        return this.httpClient.get<Array<any>>(environment.baseAuthUrl + '/federal/activities', {
            params: httpParams
        });
    }
}
