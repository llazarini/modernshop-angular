...
export class FileService {
    ...
    public store(file: any, type: string, typeId: number, token: string): Observable<IResponse<IFile>> {
        ...
        return this.httpClient.post<IResponse<IFile>>(environment.baseAuthUrl + '/files/store', form, { headers: headers });
    }

    public delete(id: number): Observable<IResponse<IFile>> {
      return this.httpClient.delete<IResponse<IFile>>(environment.baseAuthUrl + '/files/delete/' + id, {});
    }
    ...
    public images(type: string, id: number): Observable<IResponse<Array<IFile>>> {
        ...
        return this.httpClient.get<IResponse<Array<IFile>>>(environment.baseAuthUrl + '/files/images/', {
            params,
        });
    }
}
